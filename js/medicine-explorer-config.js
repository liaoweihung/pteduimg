...
window.MedicineExplorerConfigs = {
  ...
  ,tcmExternal: { key:'tcmExternal', name:'中藥外用貼布／處方外用藥', icon:'🩹', root:'' }
  ,tcmPatterns: { key:'tcmPatterns', name:'中藥外用貼布配方分析', icon:'🧪', root:'' }
};
window.MedicineExplorerLinks = [
  ...
  ,['inhaler','inhaler_medicine_explorer.html'], ['tcmExternal','tcm_external_patch_explorer.html'], ['tcmPatterns','tcm_external_formula_patterns.html']
];
